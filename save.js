...
function preload(){
  ...
  intoBg = loadImage("images/introImg.jpg");
  rulesIMG = loadImage("images/rules.jpg");
  mathBg = loadImage("images/mathsBackground.jpg");
  SciBg = loadImage("images/scienceBackground.jpg");
  englishBg = loadImage("images/englishBackground.jpg");
  spaceBg = loadImage("images/spaceBackground.jpg");
  resultIMG = loadImage("images/resultFeedback.png")
  logicalReasoningBg = loadImage("images/logicalReasoningBackground.jpg");
